...
namespace JTK.ArduinoArcade {
    /// <summary>
    /// A bas attached property to replace the vanilla WPF attached property
    /// </summary>
    ...
    public abstract class BaseAttachedProperty<Parent, Property>
        ...
        /// </summary>
        public event DependencyPropertyChangedEventHandler ValueChanged = (sender, e) => { };
        ...
        private static void OnValuePropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            ...
            Instance.OnValueChanged(d, e);  // overridable
            // Call event listeners
            Instance.ValueChanged(d, e);  // just event
        }
